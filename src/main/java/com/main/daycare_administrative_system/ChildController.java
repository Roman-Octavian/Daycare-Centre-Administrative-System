...
public class ChildController implements Initializable {
    ...
    public void injectChild(int id, String firstName, String lastName, String pic, String cpr, Date date, String gender, String guardianFirstName, String guardianLastName) {
        ...
        guardian.setAlignment(Pos.CENTER);
        guardian.setMaxWidth(99999.0);
        HBox.setHgrow(guardian,Priority.ALWAYS);
        ...
        b.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                Utilities.popUp("child_edit.fxml");
            }
        });
        ...
        hbox.getChildren().addAll(img, fullName, dob, c, g, guardian, r, b, bu);
        ...
        HBox.setMargin(guardian, new Insets(0,0,0,0));
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        back.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
                Utilities.changeScene(actionEvent, "main.fxml","Main Menu", null, true,1200,800);
            }
        });
        ...
        add.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
                    Utilities.popUp("child_add.fxml");
            }
        });
