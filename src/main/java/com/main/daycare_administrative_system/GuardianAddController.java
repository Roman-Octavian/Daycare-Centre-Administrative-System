...
public class GuardianAddController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        submit.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
                boolean check = Utilities.addGuardian(
                        imageURL,
                        iFirstName.getText(),
                        iLastName.getText(),
                        iCPR.getText(),
                        java.sql.Date.valueOf(iDoB.getValue()),
                        iGender.getText(),
                        iTelephone.getText(),
                        iChildIDField.getText());
                Alert alert;
                if (check) {
                    // Close windows
                    ...
                    alert.setContentText("Guardian Added Successfully!");
                    alert.setTitle("Add Guardian");
                    ...
                    GuardianController.refreshOnAdd = true;
